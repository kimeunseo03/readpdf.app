    ...
    <section className="print-report mt-6 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm print:border-0 print:shadow-none">
      ...
      <div className="grid gap-x-8 gap-y-6 text-sm md:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-1 font-medium text-slate-900">{input.buildingName || "-"}</p>
        </div>

        <div>
          <p className="text-slate-500">전용면적</p>
          <p className="mt-1 font-medium text-slate-900">{input.exclusiveAreaM2 || "-"}㎡</p>
        </div>

        <div>
          <p className="text-slate-500">담당자</p>
          <p className="mt-1 font-medium text-slate-900">{input.managerName || "-"}</p>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 font-medium text-slate-900">{result.comparableCount}건</p>
        </div>
      </div>
